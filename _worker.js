...
let subParams = ['sub', 'base64', 'b64', 'clash', 'singbox', 'sb', 'loon', 'cfa'];
const cmad = decodeURIComponent(atob(''));
...
async function 生成配置信息(userID, hostName, sub, UA, RproxyIP, _url, fakeUserID, fakeHostName, env) {
	...
	if (isUserAgentMozilla && !subParams.some(_searchParams => _url.searchParams.has(_searchParams))) {
		...
		const 节点配置页 = `
			...
			Clash for Android订阅地址 (已转换为兼容格式):<br>
			<a href="javascript:void(0)" onclick="copyToClipboard('https://${proxyhost}${hostName}/${uuid}?cfa','qrcode_cfa')" style="color:blue;text-decoration:underline;cursor:pointer;">https://${proxyhost}${hostName}/${uuid}?cfa</a><br>
			<div id="qrcode_cfa" style="margin: 10px 10px 10px 10px;"></div>
		...
		if (!userAgent.includes(('CF-Workers-SUB').toLowerCase()) && !_url.searchParams.has('b64')  && !_url.searchParams.has('base64')) {
			if ((userAgent.includes('clash') && !userAgent.includes('nekobox')) || (_url.searchParams.has('clash') && !userAgent.includes('subconverter'))) {
				...
				isBase64 = false;
			} else if (userAgent.includes('clash for android') || _url.searchParams.has('cfa')) {
				url = `${subProtocol}://${subConverter}/sub?target=clash&url=${encodeURIComponent(url)}&insert=false&config=${encodeURIComponent(subConfig)}&emoji=${subEmoji}&list=false&tfo=false&scv=true&fdn=false&sort=false&new_name=true`;
				isBase64 = false;
			}
		}
		...
		<body>
			...
			<div class="editor-container">
				...
				<textarea class="editor" 
					placeholder="${decodeURIComponent(atob(''))}"
...
// 修改 CFA 配置为旧版 Clash for Android 支持的格式
const CFA配置 = `
port: 7890
socks-port: 7891
allow-lan: true
...
proxies:
  - name: ${encodeURIComponent(别名)}_SS
    type: ss
    server: ${地址}
    port: ${端口}
    cipher: aes-128-gcm
    ...
    plugin-opts:
      ...
      path: "${路径}"
      mux: true
  - name: ${encodeURIComponent(别名)}_Trojan
    type: trojan
    server: ${地址}
    port: ${端口}
    password: ${用户ID}
...
proxy-groups:
  - name: 🚀 节点选择
    type: select
    proxies:
      - ${encodeURIComponent(别名)}_SS
      - ${encodeURIComponent(别名)}_Trojan
      - DIRECT
  - name: 🌍 国外媒体
    type: select
    proxies:
