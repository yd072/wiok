    ...
    const html = `
        ...
        <body>
            <div class="container">
                ...
                <div id="noticeContent" class="notice-content" style="display: none">
				    ${decodeURIComponent(atob(''))}
                </div>
    ...
    if (request.method === 'POST') {
        try {
            ...
            if (action === 'save') {
                ...
                // 获取测试参数
                const ipSource = formData.get('ipSource') || 'official';
                ...
                // 获取IP列表
                const ips = await GetCFIPs(ipSource, portSelection);
                console.log(`从${ipSource}获取到${ips.length}个IP`);
                ...
                const totalTests = ips.length;

                for (const ipString of ips) {
                    processedCount++;
                    
                    // 解析IP格式
                    const parsedIP = parseIPFormat(ipString, portSelection);
                    if (!parsedIP) continue;

                    try {
                        const result = await testIP(parsedIP, timeout);
                        ...
                        if (result.success) {
                            testResults.push({
                                ...
                                comment: parsedIP.comment || 'CF优选IP'
                            });
                        }
                        
                        // 每处理10个IP就更新一次进度
                        if (processedCount % 10 === 0 || processedCount === totalTests) {
                            const progress = {
                                percent: Math.round((processedCount / totalTests) * 100),
                                processed: processedCount,
                                total: totalTests,
                                found: testResults.length
                            };
                            console.log(`测试进度: ${progress.percent}%, 已找到${progress.found}个可用IP`);
                        }
                        
                    } catch (error) {
                        console.error(`测试IP ${parsedIP.host} 失败:`, error);
                        continue;
                    }
                }
                ...
                // 取前N个结果并格式化
                const bestIPs = testResults.slice(0, count).map(result => 
                    `${result.ip}:${result.port}#${result.comment} ${result.latency}ms`
                );
        ...
        <div class="container">
            ...
            <form id="testForm">
                <div class="form-group">
                    ...
                    <select id="ip-source-select" name="ipSource">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                // 全局变量存储测试结果
                 ...
                 progressContainer.innerHTML = 
                     ...
                     '</div>' +
                     '<div style="background-color: #f0f0f0; border-radius: 5px; height: 20px; overflow: hidden;">' +
                     '<div id="progressBar" style="background-color: #4CAF50; height: 100%; width: 0%;"></div>' +
                     '</div>' +
                     '<div style="display: flex; justify-content: space-between; margin-top: 5px; font-size: 14px; color: #666;">' +
                     '<span>已测试: <span id="testedCount">0</span>/<span id="totalCount">0</span></span>' +
                     '<span>找到IP: <span id="foundCount">0</span></span>' +
                     '</div>';
                 ...
                 const messageHandler = function(event) {
                     if (event.data && event.data.type === 'progress') {
                         try {
                             const progressData = JSON.parse(event.data.data);
                             ...
                             if (progressBar && progressText && testedCount && totalCount && foundCount) {
                                 progressBar.style.width = progressData.percent + '%';
                                 progressText.textContent = progressData.percent + '%';
                                 testedCount.textContent = progressData.processed;
                                 totalCount.textContent = progressData.total;
                                 foundCount.textContent = progressData.found;
                             }
                         } catch (e) {
                             console.error('处理进度消息出错:', e);
                         }
                     }
                 };
...
async function 测试IP连通性(ips, ports, timeout) {
    ...
    while (taskIndex < testTasks.length && results.length < minResults && (Date.now() - startTestTime) < MAX_TEST_DURATION) {
        ...
        // 简单记录进度
        if (taskIndex % 50 === 0) {
            console.log(`测试进度: ${taskIndex}/${testTasks.length}, 已找到: ${results.length}`);
        }
        ...
        for (const result of batchResults) {
            if (result.success) {
                ...
                if (results.length >= minResults) {
                    console.log(`已找到${minResults}个可用IP，提前结束测试`);
                    break;
                }
            }
        }
