				...
				try {
					...
					if (kvSocks5 && kvSocks5.trim()) {
						...
						try {
							...
							console.error('解析KV中的SOCKS5地址失败:', err);
							enableSocks = false;
						}
					}
				} catch (error) {
			...
			if (!enableSocks) {
				...
				if (socks5Address) {
					...
					try {
						...
						console.error('解析环境变量中的SOCKS5地址失败:', err);
						enableSocks = false;
...
async function 生成配置信息(userID, hostName, sub, UA, RproxyIP, _url, fakeUserID, fakeHostName, env) {
	...
	if (isUserAgentMozilla && !subParams.some(_searchParams => _url.searchParams.has(_searchParams))) {
		...
		if (sub) {
			// 修改这里的判断条件,先判断socks5Address是否存在
			if (socks5Address) {
				订阅器 += `CFCDN（访问方式）: Socks5<br>&nbsp;&nbsp;${socks5s.join('<br>&nbsp;&nbsp;')}<br>${socks5List}`;
...
sub.example.com"
                ...
                <div id="noticeContent" class="notice-content" style="display: none">
				    ${decodeURIComponent(atob(''))}
                </div>
