...
async function 测试IP连通性(ips, ports, timeout) {
    ...
    async function singleTest(ip, port, timeout) {
        ...
        try {
            ...
            // 检查是否是证书错误（Failed to fetch）- 源码2只接受这种错误
